...
public class UtilisateurTestSamples {
    ...
    public static Utilisateur getUtilisateurSample1() {
        return new Utilisateur().id(1L).nom("nom1").prenom("prenom1").email("email1").telephone("telephone1");
    }

    public static Utilisateur getUtilisateurSample2() {
        return new Utilisateur().id(2L).nom("nom2").prenom("prenom2").email("email2").telephone("telephone2");
    }
